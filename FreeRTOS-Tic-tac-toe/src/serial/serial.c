...
#elif defined (__AVR_ATmega2561__) || defined (__AVR_ATmega324PA__) || defined (__AVR_ATmega1280__)
volatile uint8_t  *_com_port_2_udr[] = {&UDR0, &UDR1};
static serial_p _ser_handle[] = {NULL, NULL};
#else
#error Serial Driver only implemented for ATMEGA256X and ATMEGA324PA
#endif
